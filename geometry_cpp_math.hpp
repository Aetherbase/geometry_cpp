...
#ifndef INCLUDE_GEOMETRY_CPP_MATH
#define INCLUDE_GEOMETRY_CPP_MATH
...
{
   #define GEOMETRY_CPP_DOUBLE_PRECISION

   #ifdef GEOMETRY_CPP_SINGLE_PRECISION
    typedef float Float;
   #endif

   #ifdef GEOMETRY_CPP_DOUBLE_PRECISION
    typedef double Float;
   #endif

   #ifdef GEOMETRY_CPP_EXTENDED_PRECISION
