...
#ifndef INCLUDE_GEOMETRY_CPP_UTILTIIES
#define INCLUDE_GEOMETRY_CPP_UTILTIIES
...
namespace geometry_cpp
{
   ...
   {
      for (unsigned int i = 0; i < geometry_cpp::segment<Type,Dimension>::PointCount; ++i)
      {
         os << segment[i];
      }
   ...
   {
      for (unsigned int i = 0; i < geometry_cpp::line<Type,Dimension>::PointCount; ++i)
      {
         os << line[i];
      }
   ...
   {
      for (unsigned int i = 0; i < geometry_cpp::triangle<Type,Dimension>::PointCount; ++i)
      {
         os << triangle[i];
      }
   ...
   {
      for (unsigned int i = 0; i < geometry_cpp::rectangle<Type>::PointCount; ++i)
      {
         os << rectangle[i];
      }
   ...
   {
      for (unsigned int i = 0; i < geometry_cpp::box<Type,Dimension>::PointCount; ++i)
      {
         os << box[i];
      }
   ...
   {
      for (unsigned int i = 0; i < geometry_cpp::quadix<Type,Dimension>::PointCount; ++i)
      {
         os << quadix[i];
      }
