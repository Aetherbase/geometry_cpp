...
namespace geometry_cpp
{
                                     ...
                                     const T& distance)
   {
      return project_point_t
             (
               source_point,
               destination_point,
               distance / geometry_cpp::distance(source_point, destination_point)
             );
   }
   ...
   {
      geometry_cpp::segment<T,D> _segment;

      for (std::size_t i = 0; i < geometry_cpp::segment<T,D>::PointCount; ++i)
      {
   ...
   template <typename T, std::size_t D>
   inline line<T,D> mirror(const line<T,D>& line, const geometry_cpp::line<T,D>& mirror_axis)
   {
      geometry_cpp::line<T,D> _line;

      for (std::size_t i = 0; i < geometry_cpp::line<T,D>::PointCount; ++i)
      {
   ...
   {
      geometry_cpp::box<T,D> _box;

      for (std::size_t i = 0; i < geometry_cpp::box<T,D>::PointCount; ++i)
      {
   ...
   {
      geometry_cpp::triangle<T,D> _triangle;

      for (std::size_t i = 0; i < geometry_cpp::triangle<T,D>::PointCount; ++i)
      {
   ...
   {
      geometry_cpp::quadix<T,D> _quadix;

      for (std::size_t i = 0; i < geometry_cpp::quadix<T,D>::PointCount; ++i)
      {
   ...
   {
      geometry_cpp::hypersphere<T,D> _sphere;
   ...
   {
      geometry_cpp::polygon<T,D> _polygon;
   ...
   {
      geometry_cpp::pointnd<T,D> _point = closest_point_on_line_from_point(axis,point);
   ...
   inline segment<T,D> project_onto_axis(const triangle<T,D>& triangle, const line<T,D>& axis)
   {
      ...
      point_list.reserve(geometry_cpp::triangle<T,D>::PointCount);
   ...
   inline segment<T,D> project_onto_axis(const box<T,D>& box, const line<T,D>& axis)
   {
      ...
      point_list.reserve(geometry_cpp::box<T,D>::PointCount);
   ...
   inline segment<T,D> project_onto_axis(const quadix<T,D>& quadix, const line<T,D>& axis)
   {
      ...
      point_list.reserve(geometry_cpp::quadix<T,D>::PointCount);
   ...
   inline polygon<T,D> make_polygon(const triangle<T,D>& triangle)
   {
      ...
      polygon.reserve(geometry_cpp::triangle<T,D>::PointCount);
   ...
   inline polygon<T,D> make_polygon(const quadix<T,D>& quadix)
   {
      ...
      polygon.reserve(geometry_cpp::quadix<T,D>::PointCount);
