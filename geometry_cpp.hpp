#ifndef INCLUDE_GEOMETRY_CPP
#define INCLUDE_GEOMETRY_CPP
...
namespace geometry_cpp
{
   ...
   template <typename T> inline bool is_right_triangle(const geometry_cpp::triangle<T,2>& triangle);
   template <typename T> inline bool is_right_triangle(const geometry_cpp::triangle<T,3>& triangle);
   ...
   template <typename T> inline line<T,2> mirror(const line<T,2>& line, const geometry_cpp::line<T,2>& mirror_axis);
   ...
   template <typename T> inline line<T,3> mirror(const line<T,3>& line, const geometry_cpp::line<T,3>& mirror_axis);
