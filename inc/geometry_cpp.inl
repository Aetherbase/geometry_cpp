...
namespace geometry_cpp
{
   ...
   inline bool intersect(const segment<T,2>& segment, const quadratic_bezier<T,2>& bezier, const std::size_t& steps)
   {
      return simplex_to_bezier_intersect
             <T,2,geometry_cpp::segment<T,2>,quadratic_bezier<T,2> >
   ...
   {
      return simplex_to_bezier_intersect
             <T,2,geometry_cpp::segment<T,2>,cubic_bezier<T,2> >
             (segment, bezier, steps);
   }
   ...
   {
      return simplex_to_bezier_intersect<T,3,geometry_cpp::segment<T,3>,quadratic_bezier<T,3> >
             (segment, bezier, steps);
   }
   ...
   {
      return simplex_to_bezier_intersect
             <T,3,geometry_cpp::segment<T,3>,cubic_bezier<T,3> >
             (segment, bezier, steps);
   }
   ...
   {
      return simplex_to_bezier_intersect
             <T,2,geometry_cpp::line<T,2>,quadratic_bezier<T,2> >
             (line, bezier, steps);
   }
   ...
   {
      return simplex_to_bezier_intersect
             <T,2,geometry_cpp::line<T,2>,cubic_bezier<T,2> >
             (line, bezier, steps);
   }
   ...
   {
      return simplex_to_bezier_intersect
             <T,3,geometry_cpp::line<T,3>,quadratic_bezier<T,3> >
             (line, bezier, steps);
   }
   ...
   {
      return simplex_to_bezier_intersect
             <T,3,geometry_cpp::line<T,3>,cubic_bezier<T,3> >
             (line, bezier, steps);
   }
   ...
   {
      return simplex_to_bezier_intersect
             <T,2,geometry_cpp::triangle<T,2>,quadratic_bezier<T,2> >
   ...
   {
      return simplex_to_bezier_intersect<T,2,geometry_cpp::triangle<T,2>,cubic_bezier<T,2> >(triangle,bezier,steps);
   }
   ...
   {
      return simplex_to_bezier_intersect
             <T,2,geometry_cpp::rectangle<T>,quadratic_bezier<T,2> >
   ...
   {
      return simplex_to_bezier_intersect
             <T,2,geometry_cpp::rectangle<T>,cubic_bezier<T,2> >
             (rectangle, bezier, steps);
   }
   ...
   {
      return simplex_to_bezier_intersect
             <T,2,geometry_cpp::quadix<T,2>,quadratic_bezier<T,2> >
             (quadix, bezier, steps);
   }
   ...
   {
      return simplex_to_bezier_intersect
             <T,2,geometry_cpp::quadix<T,2>,cubic_bezier<T,2> >
             (quadix, bezier, steps);
   }
   ...
   {
      return simplex_to_bezier_intersect<T,2,geometry_cpp::circle<T>,quadratic_bezier<T,2> >(circle,bezier,steps);
   }

   template <typename T>
   inline bool intersect(const circle<T>& circle, const cubic_bezier<T,2>& bezier, const std::size_t& steps)
   {
      return simplex_to_bezier_intersect<T,2,geometry_cpp::circle<T>,cubic_bezier<T,2> >(circle,bezier,steps);
   }
   ...
   {
      return simplex_to_bezier_intersect<T,3,geometry_cpp::sphere<T>,quadratic_bezier<T,3> >(sphere,bezier,steps);
   }

   template <typename T>
   inline bool intersect(const sphere<T>& sphere, const cubic_bezier<T,3>& bezier, const std::size_t& steps)
   {
      return simplex_to_bezier_intersect<T,3,geometry_cpp::sphere<T>,cubic_bezier<T,3> >(sphere,bezier,steps);
   }
                                  ...
                                  const std::size_t& steps)
   {
      ...
      <T, 2, geometry_cpp::segment<T,2>, quadratic_bezier<T,2>, OutputIterator>
      (
        segment,
        bezier,
        out,
   ...
   {
      simplex_to_bezier_intersection_point
      <T,2,geometry_cpp::segment<T,2>,cubic_bezier<T,2>,OutputIterator>
      (
        segment,
        bezier,
        out,
   ...
   {
      simplex_to_bezier_intersection_point
      <T,3,geometry_cpp::segment<T,3>,quadratic_bezier<T,3>,OutputIterator>
      (
        segment,
        bezier,
        out,
   ...
   {
      simplex_to_bezier_intersection_point
      <T,3,geometry_cpp::segment<T,3>,cubic_bezier<T,3>,OutputIterator>
      (
        segment,
        bezier,
        out,
                                           ...
                                           const std::size_t& steps)
   {
      ...
      for (std::size_t i = 1; i < steps; ++i)
      {
         ...
         geometry_cpp::segment<T,Dimension> segment = make_segment(previous_point,current_point);
   ...
   {
      geometry_cpp::segment<T,2> tmp_segment = translate(-circle.x, -circle.y, segment);

      const T rsqr  = geometry_cpp::sqr(circle.radius);
      const T drsqr = lay_distance(tmp_segment);
      const T dsqr  = geometry_cpp::sqr(tmp_segment[0].x * tmp_segment[1].y - tmp_segment[1].x * tmp_segment[0].y);
   ...
   {
      geometry_cpp::triangle<T,2> tri = triangle;
      ...
      const geometry_cpp::triangle<T,2> triangle1 = create_triangle(edge(tri, 0), angle1, angle2);
      const geometry_cpp::triangle<T,2> triangle2 = create_triangle(edge(tri, 1), angle2, angle3);
      const geometry_cpp::triangle<T,2> triangle3 = create_triangle(edge(tri, 2), angle3, angle1);
   ...
   inline triangle<T,2> create_anticevian_triangle(const triangle<T,2>& triangle, const point2d<T>& point)
   {
      ...
      {
         typedef const geometry_cpp::line<T,2> line2d_t;

         line2d_t opp_edge    = geometry_cpp::make_line(opposing_edge(triangle,i));
         line2d_t cevian_edge = geometry_cpp::make_line(triangle[i],point);
         line2d_t orthic_edge = geometry_cpp::make_line
                                        (
                                          triangle[i],
                                          geometry_cpp::closest_point_on_line_from_point(opp_edge,triangle[i])
                                        );

         //if (!robust_collinear(orthic_edge,point))
         {
            point_list[i] = geometry_cpp::intersection_point(cevian_edge, make_line(orthic_edge[i], geometry_cpp::mirror(point,opp_edge)));
         }
         //else
   ...
   {
      const point2d<T> p = make_point(geometry_cpp::inscribed_circle(triangle));
   ...
   {
      geometry_cpp::triangle<T,2> triangle_ = create_excentral_triangle(triangle);
   ...
   {
      geometry_cpp::triangle<T,3> triangle_ = create_excentral_triangle(triangle);
   ...
   inline triangle<T,2> create_circumcevian_triangle(const triangle<T,2>& triangle, const point2d<T>& point)
   {
      ...
      geometry_cpp::triangle<T,2> triangle_ = degenerate_triangle2d<T>();
   ...
   inline triangle<T,2> create_first_brocard_triangle(const triangle<T,2>& triangle)
   {
      ...
      geometry_cpp::triangle<T,2> result;
   ...
   template <typename T> inline void create_right_triangle(const geometry_cpp::point2d<T>& p1, const geometry_cpp::point2d<T>& p2,
                                                                 geometry_cpp::point2d<T>& c1,       geometry_cpp::point2d<T>& c2)
   {
      const T distance = geometry_cpp::distance(p1,p2);

      const geometry_cpp::point2d <T> mid = geometry_cpp::segment_mid_point(p1,p2);
      const geometry_cpp::vector2d<T>   v = geometry_cpp::normalize(geometry_cpp::perpendicular(p1 - p2)) * (distance / T(2.0));
                                             ...
                                             std::vector<line<T,2> >& lines)
   {
      ...
      else
      {
         ...
         geometry_cpp::point2d<T> c0pnt0;
         geometry_cpp::point2d<T> c0pnt1;
         geometry_cpp::point2d<T> c1pnt0;
         geometry_cpp::point2d<T> c1pnt1;

         geometry_cpp::circle_tangent_points(circle0, i, c0pnt0, c0pnt1);
         geometry_cpp::circle_tangent_points(circle1, i, c1pnt0, c1pnt1);
                                          ...
                                          std::vector< line<T,2> >& lines)
   {
      ...
      else
      {
         ...
         geometry_cpp::circle_tangent_points(circle0, p, c0pnt0, c0pnt1);
         geometry_cpp::circle_tangent_points(circle1, p, c1pnt0, c1pnt1);
                                                        ...
                                                        const std::size_t& steps)
   {
      ...
      geometry_cpp::generate_bezier(bezier,std::back_inserter(point_list),steps);
   ...
   {
      geometry_cpp::polygon<T,2> polygon_;
   ...
   template <typename T>
   inline bool is_right_triangle(const geometry_cpp::triangle<T,2>& triangle)
   {
      const T a = geometry_cpp::lay_distance(geometry_cpp::edge(triangle,0));
      const T b = geometry_cpp::lay_distance(geometry_cpp::edge(triangle,1));
      const T c = geometry_cpp::lay_distance(geometry_cpp::edge(triangle,2));

      return geometry_cpp::is_equal(a + b,c) || geometry_cpp::is_equal(a + c,b) || geometry_cpp::is_equal(b + c,a);
   }

   template <typename T>
   inline bool is_right_triangle(const geometry_cpp::triangle<T,3>& triangle)
   {
      const T a = geometry_cpp::lay_distance(geometry_cpp::edge(triangle,0));
      const T b = geometry_cpp::lay_distance(geometry_cpp::edge(triangle,1));
      const T c = geometry_cpp::lay_distance(geometry_cpp::edge(triangle,2));
   ...
   {
      geometry_cpp::segment<T,2> segment_;

      for (std::size_t i = 0; i < geometry_cpp::segment<T,2>::PointCount; ++i)
      {
   ...
   template <typename T>
   inline line<T,2> mirror(const line<T,2>& line, const geometry_cpp::line<T,2>& mirror_axis)
   {
      geometry_cpp::line<T,2> line_;

      for (std::size_t i = 0; i < geometry_cpp::line<T,2>::PointCount; ++i)
      {
   ...
   {
      geometry_cpp::rectangle<T> rectangle_;

      for (std::size_t i = 0; i < geometry_cpp::rectangle<T>::PointCount; ++i)
      {
   ...
   {
      geometry_cpp::triangle<T,2> triangle_;

      for (std::size_t i = 0; i < geometry_cpp::triangle<T,2>::PointCount; ++i)
      {
   ...
   {
      geometry_cpp::quadix<T,2> quadix_;

      for (std::size_t i = 0; i < geometry_cpp::quadix<T,2>::PointCount; ++i)
      {
   ...
   {
      geometry_cpp::circle<T> circle_ = circle;
   ...
   {
      geometry_cpp::segment<T,3> segment_;

      for (std::size_t i = 0; i < geometry_cpp::segment<T,3>::PointCount; ++i)
      {
         segment_[i] = mirror(segment[i],mirror_axis);
      }
   ...
   template <typename T>
   inline line<T,3> mirror(const line<T,3>& line, const geometry_cpp::line<T,3>& mirror_axis)
   {
      geometry_cpp::line<T,3> line_;

      for (std::size_t i = 0; i < geometry_cpp::line<T,3>::PointCount; ++i)
      {
         line_[i] = mirror(line[i],mirror_axis);
      }
   ...
   {
      geometry_cpp::box<T,3> box_;

      for (std::size_t i = 0; i < geometry_cpp::box<T,3>::PointCount; ++i)
      {
   ...
   {
      geometry_cpp::triangle<T,3> triangle_;

      for (std::size_t i = 0; i < geometry_cpp::triangle<T,3>::PointCount; ++i)
      {
         triangle_[i] = mirror(triangle[i],mirror_axis);
      }
   ...
   {
      geometry_cpp::quadix<T,3> quadix_;

      for (std::size_t i = 0; i < geometry_cpp::quadix<T,3>::PointCount; ++i)
      {
         quadix_[i] = mirror(quadix[i],mirror_axis);
      }
   ...
   {
      geometry_cpp::sphere<T> sphere_ = sphere;
   ...
   {
      geometry_cpp::polygon<T,3> polygon_;
      polygon_.reserve(polygon.size());
   ...
   inline polygon<T,2> minkowski_sum(const triangle<T,2>& triangle1, const triangle<T,2>& triangle2)
   {
      ...
      for (std::size_t i = 0; i < geometry_cpp::triangle<T,2>::PointCount; ++i)
      {
         for (std::size_t j = 0; j < geometry_cpp::triangle<T,2>::PointCount; ++j)
         {
   ...
   inline polygon<T,2> minkowski_sum(const quadix<T,2>& quadix1, const quadix<T,2>& quadix2)
   {
      ...
      for (std::size_t i = 0; i < geometry_cpp::quadix<T,2>::PointCount; ++i)
      {
         for (std::size_t j = 0; j < geometry_cpp::quadix<T,2>::PointCount; ++j)
         {
   ...
   {
      geometry_cpp::polygon<T,2> polygon;
      geometry_cpp::polygon<T,2> circle_polygon = make_polygon(circle);
   ...
   {
      geometry_cpp::point2d<T> point_ = closest_point_on_line_from_point(axis,point);
   ...
   {
      geometry_cpp::point3d<T> point_ = closest_point_on_line_from_point(axis,point);
      return make_segment(point_,point_);
   }
   ...
   {
      geometry_cpp::segment<T,2> segment_ = segment;
   ...
   {
      geometry_cpp::segment<T,3> segment_ = segment;
   ...
   inline rectangle<T> aabb(const triangle<T,2>& triangle)
   {
      ...
      for (std::size_t i = 1; i < geometry_cpp::triangle<T,2>::PointCount; ++i)
      {
   ...
   inline rectangle<T> aabb(const quadix<T,2>& quadix)
   {
      ...
      for (std::size_t i = 1; i < geometry_cpp::quadix<T,2>::PointCount; ++i)
      {
   ...
   {
      geometry_cpp::rectangle<T> rectangle_ = aabb(triangle);
   ...
   {
      geometry_cpp::rectangle<T> rectangle_ = aabb(rectangle);
   ...
   {
      geometry_cpp::rectangle<T> rectangle_ = aabb(quadix);
   ...
   {
      geometry_cpp::rectangle<T> rectangle_ = aabb(circle);
   ...
   inline box<T,3> aabb(const triangle<T,3>& triangle)
   {
      ...
      for (std::size_t i = 1; i < geometry_cpp::triangle<T,3>::PointCount; ++i)
      {
   ...
   inline box<T,3> aabb(const quadix<T,3>& quadix)
   {
      ...
      for (std::size_t i = 1; i < geometry_cpp::quadix<T,3>::PointCount; ++i)
      {
   ...
   {
      geometry_cpp::box<T,3> box_ = aabb(box);
      x1 = box_[0].x;
      y1 = box_[0].y;
      z1 = box_[0].z;
      x2 = box_[1].x;
   ...
   {
      geometry_cpp::box<T,3> region = make_box(x1,y1,z1,x2,y2,z2);
   ...
   {
      return geometry_cpp::scale(scale,scale,point);
   }

   template <typename T>
   inline point3d<T> operator*(const point3d<T>& point, const T& scale)
   {
      return geometry_cpp::scale(scale,scale,scale,point);
   }
   ...
   {
      geometry_cpp::polygon<T,D> polygon_;
   ...
   inline polygon<T,2> make_polygon(const triangle<T,2>& triangle)
   {
      ...
      polygon_.reserve(geometry_cpp::triangle<T,2>::PointCount);
   ...
   inline polygon<T,2> make_polygon(const quadix<T,2>& quadix)
   {
      ...
      polygon_.reserve(geometry_cpp::quadix<T,2>::PointCount);
