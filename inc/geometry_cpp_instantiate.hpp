#ifndef INCLUDE_GEOMETRY_CPP_INSTANTIATE
#define INCLUDE_GEOMETRY_CPP_INSTANTIATE


#include "geometry_cpp.hpp"
#include "geometry_cpp_nd.hpp"
#include "geometry_cpp_algorithm.hpp"
#include "geometry_cpp_utilities.hpp"


namespace geometry_cpp
{
   #define INSTANTIATE_GEOMETRY_CPP(T,InputIterator2d,InputIterator3d,OutputIterator2d,OutputIterator3d)\
      ...
      template void create_right_triangle<T>(const geometry_cpp::point2d<T>& p1, const geometry_cpp::point2d<T>& p2, geometry_cpp::point2d<T>& c1, geometry_cpp::point2d<T>& c2);\
      ...
      template bool is_right_triangle<T>(const geometry_cpp::triangle<T,2>& triangle);\
      template bool is_right_triangle<T>(const geometry_cpp::triangle<T,3>& triangle);\
      ...
      template line<T,2> mirror<T>(const line<T,2>& line, const geometry_cpp::line<T,2>& mirror_axis);\
      ...
      template line<T,3> mirror<T>(const line<T,3>& line, const geometry_cpp::line<T,3>& mirror_axis);\
   ...
   #define INSTANTIATE_GEOMETRY_CPP_ND(T, D, OutputIterator)\
      ...
      template pointnd<T,D> closest_point_on_segment_from_point<T,D>(const segment<T,D>& segment, const geometry_cpp::segment<T,D>::PointType& point);\
      template pointnd<T,D> closest_point_on_line_from_point<T,D>(const line<T,D>& segment, const geometry_cpp::line<T,D>::PointType& point);\
      template pointnd<T,D> closest_point_on_sphere_from_point<T,D>(const hypersphere<T,D>& sphere, const geometry_cpp::hypersphere<T,D>::PointType& point);\
      template pointnd<T,D> closest_point_on_plane_from_point<T,D>(const plane<T,D>& plane, const geometry_cpp::plane<T,D>::PointType& point);\
      template pointnd<T,D> closest_point_on_box_from_point<T,D>(const box<T,D>& box, const geometry_cpp::box<T,D>::PointType& point);\
      ...
      template line<T,D> mirror<T,D>(const line<T,D>& line, const geometry_cpp::line<T,D>& mirror_axis);\
   ...
   #define INSTANTIATE_GEOMETRY_CPP_MATH(T)                                \
   ...
   #define INSTANTIATE_GEOMETRY_CPP_UTILITIES_1(T)                                                 \
   ...
   #define INSTANTIATE_GEOMETRY_CPP_UTILITIES_2(T,D)                                                 \
   ...
   #define INSTANTIATE_GEOMETRY_CPP_ALGORITHMS(T,K)                                                                                                \
   ...
   typedef geometry_cpp::point2d<float>*  flt_pnt_2d;
   typedef geometry_cpp::point2d<double>* dbl_pnt_2d;

   typedef geometry_cpp::point3d<float>*  flt_pnt_3d;
   typedef geometry_cpp::point3d<double>* dbl_pnt_3d;

   INSTANTIATE_GEOMETRY_CPP( float, flt_pnt_2d, flt_pnt_3d, flt_pnt_2d, flt_pnt_3d)
   INSTANTIATE_GEOMETRY_CPP(double, dbl_pnt_2d, dbl_pnt_3d, dbl_pnt_2d, dbl_pnt_3d)
   ...
   INSTANTIATE_GEOMETRY_CPP_ND(float,  4,  pointnd_flt_4)
   INSTANTIATE_GEOMETRY_CPP_ND(float,  5,  pointnd_flt_5)
   INSTANTIATE_GEOMETRY_CPP_ND(float,  6,  pointnd_flt_6)
   INSTANTIATE_GEOMETRY_CPP_ND(float,  7,  pointnd_flt_7)
   INSTANTIATE_GEOMETRY_CPP_ND(float,  8,  pointnd_flt_8)
   INSTANTIATE_GEOMETRY_CPP_ND(float,  9,  pointnd_flt_9)
   INSTANTIATE_GEOMETRY_CPP_ND(float, 10, pointnd_flt_10)

   INSTANTIATE_GEOMETRY_CPP_ND(double,  4,  pointnd_dbl_4)
   INSTANTIATE_GEOMETRY_CPP_ND(double,  5,  pointnd_dbl_5)
   INSTANTIATE_GEOMETRY_CPP_ND(double,  6,  pointnd_dbl_6)
   INSTANTIATE_GEOMETRY_CPP_ND(double,  7,  pointnd_dbl_7)
   INSTANTIATE_GEOMETRY_CPP_ND(double,  8,  pointnd_dbl_8)
   INSTANTIATE_GEOMETRY_CPP_ND(double,  9,  pointnd_dbl_9)
   INSTANTIATE_GEOMETRY_CPP_ND(double, 10, pointnd_dbl_10)
   */

   INSTANTIATE_GEOMETRY_CPP_MATH(float)
   INSTANTIATE_GEOMETRY_CPP_MATH(double)

   INSTANTIATE_GEOMETRY_CPP_UTILITIES_1(float)
   INSTANTIATE_GEOMETRY_CPP_UTILITIES_1(double)

   INSTANTIATE_GEOMETRY_CPP_UTILITIES_2(float,2)
   INSTANTIATE_GEOMETRY_CPP_UTILITIES_2(double,2)

   INSTANTIATE_GEOMETRY_CPP_UTILITIES_2(float,3)
   INSTANTIATE_GEOMETRY_CPP_UTILITIES_2(double,3)

   INSTANTIATE_GEOMETRY_CPP_ALGORITHMS(float, f)
   INSTANTIATE_GEOMETRY_CPP_ALGORITHMS(double,d)
