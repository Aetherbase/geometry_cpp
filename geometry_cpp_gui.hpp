...
class geometry_cpp_window;
static geometry_cpp_window* handle;
...
public:
   ...
   geometry_cpp_window(int argc, char* argv[])
   {
   ...
   virtual std::string window_title() { return std::string("Geometry_Cpp Window"); }
